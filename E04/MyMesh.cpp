...
void MyMesh::GenerateCircle(float a_fRadius, int a_nSubdivisions, vector3 a_v3Color)
{
	...
	*/
	...
	{
		// create points
		vector3 pointA = vector3(a_fRadius * cos((2.0f * PI) * i / (float)a_nSubdivisions), a_fRadius * sin((2.0f * PI) * i / (float)a_nSubdivisions), 0);
		vector3 pointB = vector3(a_fRadius * cos((2.0f * PI) * (i + 1) / (float)a_nSubdivisions), a_fRadius*sin((2.0f * PI) * (i + 1) / (float)a_nSubdivisions), 0);
		vector3 pointC = vector3(0, 0, 0);
